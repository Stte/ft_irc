...
{
    static const std::string array[18] ={ "JOIN", "NICK", "USER","PASS","CAP","MODE","KICK","PING","PONG","INVITE","PRIVMSG","QUIT","TOPIC","PART","WHO","WHOIS", "ERROR"};
    for (int i = 0; i < IRCCommand::ERROR; i++)
    {
        if (cmd == array[i])
